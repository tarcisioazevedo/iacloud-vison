...
const SECTIONS = [
  { id: 'intro', title: '1. Introdução', content: `A IA Cloud Vision LTDA ("ICV", "nós") está comprometida com a privacidade e a proteção dos dados pessoais de seus Usuários, em conformidade com a Lei Geral de Proteção de Dados (LGPD — Lei nº 13.709/2018).\n\nEsta Política descreve como coletamos, utilizamos, armazenamos e protegemos os dados pessoais no contexto da Plataforma VSaaS de visão computacional.` },
  ...
  { id: 'dpo', title: '11. Encarregado de Dados (DPO)', content: `O Encarregado de Proteção de Dados da IA Cloud Vision pode ser contatado pelo e-mail: privacidade@iacloudvision.com.br\n\nTambém é possível registrar reclamações perante a Autoridade Nacional de Proteção de Dados (ANPD) em: www.gov.br/anpd` },
      ...
      <div className="py-16 px-6 text-white" style={{ background: 'linear-gradient(135deg, #0B1629 0%, #0e2a50 50%, #0369a1 100%)' }}>
        <div className="max-w-5xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            ...
            <p className="text-slate-300 max-w-2xl">Como coletamos, usamos e protegemos seus dados pessoais na Plataforma IA Cloud Vision.</p>
