          ...
          {[
            ...
            <div key={s.n} className="flex items-center gap-2 sm:gap-4">
              <div className={cn(
                ...
                step === s.n
                  ? 'bg-brand-sky/20 border-brand-sky/50 text-white shadow-[0_0_15px_rgba(56,189,248,0.3)]'
                  : step > s.n
          ...
          {step === 2 && (
            ...
            >
              ...
              <div className="space-y-4">
                <div className="relative aspect-video bg-black rounded-xl overflow-hidden border border-brand-sky/20 shadow-[0_0_40px_rgba(56,189,248,0.1)] group">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="absolute -right-2 top-0 translate-x-full flex flex-col gap-0.5">
                            ...
                            <div className="px-2 py-0.5 text-[9px] font-mono text-white/70 bg-black/50 backdrop-blur-sm w-fit">
                  ...
                  <div className="absolute top-4 left-4 z-40 flex items-center gap-3">
                    <div className="flex items-center gap-2 px-2 py-1 bg-black/50 border border-white/10 rounded backdrop-blur-md">
                    ...
                    <div className="px-2 py-1 bg-black/50 border border-white/10 rounded backdrop-blur-md text-brand-skyLight text-[10px] font-mono">
                ...
                <div className="flex items-center justify-between gap-3">
                  <button
                    onClick={() => setStep(1)}
                    className="px-4 py-2.5 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-400 text-sm font-semibold hover:text-white transition flex items-center gap-2"
                  >
                    <ArrowLeft className="w-4 h-4" /> Voltar
                  </button>
                  <button
                    onClick={() => setStep(3)}
                    className="flex-1 px-5 py-3 rounded-lg bg-brand-gradient text-white font-bold text-sm flex items-center justify-center gap-2 hover:shadow-[0_0_20px_rgba(56,189,248,0.4)] transition-all hover:-translate-y-0.5"
                  >
              ...
              <div className="space-y-4 flex flex-col">
                <div className="bg-black/40 border border-white/10 rounded-xl p-4 shadow-xl">
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 z-10">
                            <p className={cn('text-sm font-bold tracking-wide', on ? 'text-white' : 'text-slate-400')}>
                              {a.label}
                            </p>
                          </div>
                          <div className={cn(
                            'w-10 h-5 rounded-full border transition-all relative z-10',
                            on ? cn(c.bg, c.border) : 'bg-white/10 border-white/20',
                          )}>
                            <span className={cn(
                ...
                <div className="flex-1 bg-black/80 border border-white/10 rounded-xl p-4 flex flex-col overflow-hidden min-h-[200px]">
                    ...
                    {boxes.map((b, i) => {
                      ...
                      return (
                         ...
                         >
                           ...
                           <span className="text-slate-300 flex-1 truncate">Detected {b.label} at x:{b.x.toFixed(1)} y:{b.y.toFixed(1)}</span>
                         </motion.div>
                      )
                    }).slice(0, 5)}
                     <motion.div
