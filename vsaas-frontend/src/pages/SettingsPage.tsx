...
import {
  ...
  type AlertRecipient, type AlertConfig,
...
const SECTIONS = [
  ...
  // será gerido via /admin/integradores e relatórios separados.
...
// ═══════════════════════════════════════════════════════════════════════════
// BILLING
// BillingSection removida — seção de billing migrada para /admin/integradores
// e relatórios separados. Faturamento não aparece mais em SettingsPage.
...
function StorageGlobalDashboard() {
  ...
  const [expandedId, _setExpandedId] = useState<string | null>(null)        // legado (mantido p/ retrocompat na linha)
...
function TenantDrillPanel({
  ...
  const [_reqLoading, setReqLoading]   = useState(false)
