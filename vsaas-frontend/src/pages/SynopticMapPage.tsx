            ...
            <div className="p-4">
              ...
              <div className="flex gap-2 mt-3">
                ...
                <button
                  ...
                  className="flex-1 py-1.5 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-400 text-xs font-medium flex items-center justify-center gap-1 hover:bg-slate-200 dark:hover:bg-white/10 transition"
                >
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-5">
        <button onClick={onBack} className="p-2 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 text-slate-500 dark:text-slate-400">
          ...
          {!imageUrl ? (
            ...
            >
                ...
                return (
                  ...
                  >
                    <div className="relative flex flex-col items-center">
                      ...
                      <span className="mt-1 text-[10px] font-semibold bg-black/70 text-white px-1.5 py-0.5 rounded whitespace-nowrap max-w-[100px] truncate">
              ...
              <button
                ...
                className="absolute top-2 right-2 px-2 py-1 rounded text-[10px] bg-black/50 text-white hover:bg-black/70 flex items-center gap-1"
              >
  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <button
          onClick={onEdit}
          className="px-3 py-2 rounded-lg border border-slate-200 dark:border-white/10 text-slate-600 dark:text-slate-300 text-sm flex items-center gap-1.5 hover:bg-slate-100 dark:hover:bg-white/5"
        >
    ...
    <>
      ...
      >
        <div className="relative flex flex-col items-center">
          ...
          <span className="mt-1 text-[10px] font-semibold bg-black/75 text-white px-1.5 py-0.5 rounded whitespace-nowrap max-w-[120px] truncate shadow">
  ...
  return (
    ...
    >
      ...
      <div className="p-2.5 space-y-0.5">
        <p className="text-xs font-bold text-white truncate">{fc.label ?? fc.camera.name}</p>
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-slate-200 dark:border-white/10">
          ...
          <button onClick={onClose} className="p-1.5 hover:bg-slate-100 dark:hover:bg-white/10 rounded-lg text-slate-400 hover:text-slate-900 dark:hover:text-white">
            <X className="w-4 h-4" />
          </button>
        </div>
