  ...
  return (
    <button
      ...
      className={cn(
        ...
        active ? 'text-cyan-700 dark:text-cyan-300' : 'text-slate-500 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-300',
        className,
      )}
    >
      {label}
      ...
      <div className="relative p-6 space-y-5">
        ...
        <div className="flex items-center justify-between flex-wrap gap-3">
          <div className="flex items-start gap-3">
            <Link
              to="/analytics"
              className="mt-1 p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-white/5 text-slate-700 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition"
        ...
        <GlassCard className="p-3" delay={0.25}>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <label className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-50 dark:bg-white/[0.03] border border-slate-200 dark:border-white/10 text-xs text-slate-700 dark:text-slate-300 cursor-pointer hover:bg-slate-100 dark:hover:bg-white/5">
              <input
                type="checkbox"
                checked={onlyBreach}
