        ...
        <div className="p-5 space-y-3 max-h-[70vh] overflow-y-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <div className="flex items-end">
              <label className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-xs text-slate-600 dark:text-slate-300 cursor-pointer w-full">
                <input
                  type="checkbox"
          ...
          <div className="pt-3 border-t border-slate-200 dark:border-white/5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <label className="flex items-center gap-2 px-3 py-2 rounded-lg bg-slate-100 dark:bg-white/5 border border-slate-200 dark:border-white/10 text-xs text-slate-600 dark:text-slate-300 cursor-pointer mt-5">
                <input
                  type="checkbox"
...
function DeleteConfirmModal({ rule, onCancel, onConfirm }: {
  ...
  return (
    ...
    >
      ...
      >
        <header className="px-5 py-4 border-b border-slate-200 dark:border-white/10 flex items-center gap-2.5">
