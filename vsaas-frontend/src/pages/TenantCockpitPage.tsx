    ...
    <div className="space-y-4">
      ...
      <GlassCard className="p-5 bg-gradient-to-br from-violet-500/10 via-cyan-500/5 to-transparent border-violet-500/20">
        <div className="flex items-start justify-between gap-3 flex-wrap">
          ...
          {/* Botão "+ Novo integrador" movido para o cabeçalho da tabela
              (paridade pixel mockup 01) */}
        </div>
      </GlassCard>
      ...
      {/* Lista de integradores (tabela paridade mockup 01) */}
        ...
        <div className="flex items-center justify-between gap-3 mb-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 py-1.5 rounded-lg bg-gradient-to-r from-violet-500 to-cyan-500 hover:opacity-90 text-white text-xs font-bold shadow-lg shadow-violet-500/20 transition"
            >
