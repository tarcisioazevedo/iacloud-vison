"""
Yolov8Detector — wrapper Ultralytics com threshold POR CLASSE.

NOTA: mantido por compatibilidade e rollback. Para uso comercial em produção,
prefira YOLO-NAS via yolonas_detector.py (Apache 2.0 vs AGPL-3.0).
